...
const Home = () => {
  return (
    <header id="home" class="h-screen flex flex-col items-center pt-6">
      <div class="md:flex md:flex-row md:space-x-10 sm:flex-col items-center container mx-auto lg:pt-44 md:pt-36 pt-10 px-10">
        <div class="basis-1/2 lg:text-4xl md:text-2xl text-xl inline-block pt-4">
