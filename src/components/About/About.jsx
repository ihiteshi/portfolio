...
const About = () => {
  return (
    <section id="about" class="h-screen">
      ...
      <p>
      My educational background includes a Master's degree in Information Technology from Queensland University of Technology, where I specialized in network management, coupled with a Bachelor's degree in Computer Application from Jain University, focusing on mobile application development and computer security.
      </p>
      <p>
      Certified in <a 
        ...
        rel="noreferrer"
        target="_blank"
      >Microsoft Azure Fundamentals</a> and skilled in <a 
      ...
      , I bring a comprehensive understanding of cloud computing and data analytics to the table.
      </p>
      <div class="flex p-2">
      <SiMicrosoftazure class="flex-auto p-3 mt-2" size="150px"color='#cacfcc'/>
